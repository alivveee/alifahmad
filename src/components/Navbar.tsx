  ...
  return (
    <>
      ...
      <nav
        ...
        className={`fixed left-0 right-0 z-50 transition-all duration-500 ease-out ${isScrolled ? "top-4 px-4 md:px-8" : "top-0 px-0"}`}
      >
        <div
        ...
        {/* Mobile Menu */}
        <div
          className={`absolute left-0 right-0 mx-auto transition-all duration-500 ease-out overflow-hidden z-40
          ${isScrolled ? "top-[75px] max-w-3xl px-4 md:px-8" : "top-full w-full px-0"}`}
        >
          <div
            className={`w-full backdrop-blur-lg bg-zinc-900/95 transition-all duration-500 ease-out
