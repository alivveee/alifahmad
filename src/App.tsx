      ...
      <div className="hero grid md:grid-cols-2">
        <div className="flex flex-col justify-center">
          ...
          <p className="mt-5 text-base/relaxed opacity-70">
            Passionate about building user-friendly web applications, I
            specialize in building accessible user interfaces. As a{" "}
            <b>developer</b>, I constantly explore modern technologies and ready
            to collaborate on building reliable and impactful products.
          </p>
        ...
        <div className="flex justify-center items-center p-10 order-first md:order-last">
          <img
            src={Image.HeroImage}
            alt="Hero Image"
            className="w-[300px] max-w-full h-auto rounded-full shadow-[0_0_55px_#7F22FE] filter grayscale hover:grayscale-25"
          />
        </div>
      </div>
    </>
